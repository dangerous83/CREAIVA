...
async function submit(question) {
  ...
  try {
    ...
    waiting.remove();
    const article = message('I couldn’t load the website information just now. Please try again, or contact CREAIVA at creaiva.ultra@gmail.com or +971 56 664 4147.');
    responseElement = article;
    const a = document.createElement('a');
